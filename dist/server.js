...
import { addMultipleTranslations, addTranslation, checkTranslationIntegrity, deleteTranslation, getTranslations, } from './tools.js';
const config = readConfig();
const server = new Server({ name: 'i18n-mcp', version: '0.1.0' }, { capabilities: { tools: {} } });
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: 'get_translations',
            description: 'Get all translations for a namespace as { key: { locale: value } } pairs. ' +
        ...
        },
        {
            ...
            description: 'Add or update a single translation key across one or more locales. ' +
        ...
        },
        {
            ...
            description: 'Add or update multiple translation keys in one operation. ' +
        ...
        },
        {
            ...
            description: 'Compare all locale files against the primary locale. ' +
